                        ...
                        <form action="{{ route('herosections.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="badge_icon" value="{{ old('badge_icon') }}"
                                        class="form-control" placeholder="e.g. bi-star-fill">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="btn1_text" value="{{ old('btn1_text') }}"
                                        class="form-control">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Button 1 URL</label>
                                    <input type="url" name="btn1_url" value="{{ old('btn1_url') }}"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="btn2_text" value="{{ old('btn2_text') }}"
                                        class="form-control">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Button 2 URL</label>
                                    <input type="url" name="btn2_url" value="{{ old('btn2_url') }}"
                                        class="form-control">
                                </div>
                            </div>

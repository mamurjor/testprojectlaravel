...
<head>
    ...
    <!--- Favicon --->
    <link rel="icon" href="../../assets/img/brand/favicon.png" type="image/icon" />
        ...
        <div class="container-fluid">
            <div class="row no-gutter">
                ...
                <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                    <div class="row wd-100p mauto text-center">
                        <div class="col-md-12 col-lg-12 col-xl-12 my-auto mauto wd-100p">
                            <img src="../../assets/img/media/login.png"
                                class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mauto" alt="logo">
                        </div>
                    </div>
                </div>
                <!-- The content half -->
                <div class="col-md-6 col-lg-6 col-xl-5 bg-white">
                    <div class="login d-flex align-items-center py-2">
                        ...
                        <div class="container p-0">
                            <div class="row">
                                <div class="col-md-10 col-lg-10 col-xl-9 mauto">
                                    <div class="card-sigin">
                                        <div class="mb-5 d-flex"> <a href="index.html"><img
                                                    src="../../assets/img/brand/favicon.png" class="sign-favicon ht-40"
                                                    alt="logo"></a>
                                            <h1 class="main-logo1 ml-1 mr-0 my-auto t28">Va<span>le</span>x</h1>
                                        </div>
                                        <div class="main-signup-header">
                                            ...
                                            <form method="POST" action="{{ route('register') }}"
                                                ...
                                                <input id="password_confirmation" label="Confirm Password"
                                                    type="password" name="password_confirmation" required />

                                                <input-label for="password_confirmation"

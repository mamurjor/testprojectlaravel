...
@section('maincontent')
    ...
    {{-- Scripts --}}
    @push('scripts')
        {{-- যদি লেআউটে Bootstrap bundle আগে থেকেই থাকে, নিচের লাইনটি বাদ দিন --}}
        ...
        <script>
            (function() {
                ...
                // Client-side validation visual + invalid হলে সংশ্লিষ্ট ট্যাবে জাম্প
                    ...
                    if (!form.checkValidity()) {
                        ...
                        if (invalid) {
                            ...
                            if (pane && !pane.classList.contains('active')) {
                                ...
                                const idx = tabs.findIndex(btn => btn.getAttribute('data-bs-target') === ('#' +
                                id));
                ...
                // File previews
                function previewImg(input, imgEl) {
                ...
                const coverInput = document.getElementById('coverBannerInput');
                const coverPreview = document.getElementById('coverBannerPreview');

                profileInput?.addEventListener('change', () => previewImg(profileInput, profilePreview));
                coverInput?.addEventListener('change', () => previewImg(coverInput, coverPreview));
